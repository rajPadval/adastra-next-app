...
const About = () => {
  return (
    <section className="bg-gradient-to-b from-black to-transparent h-full">
      ...
      <div className="mx-[5vw] mb-10 mt-24">
      ...
      <div className="flex py-8 px-10 bg-black bg-opacity-30 w-fit gap-10 mx-auto">
      ...
      {/* more paragraph */}
      <p className="text-md lg:text-lg uppercase font-thin text-start lg:text-center mx-[5vw] mt-10 mb-24">
