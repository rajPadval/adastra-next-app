...
const AdminNavbar = () => {
  return (
    <div className="w-[75vw] lg:w-fit mx-auto h-fit lg:h-full flex  lg:flex-col gap-8 justify-center items-center fixed lg:top-0 left-0 right-0 lg:right-full  bottom-5  backdrop-blur-2xl  rounded-lg px-5 py-2 border lg:border-none border-r-zinc-600 bg-white bg-opacity-5">
